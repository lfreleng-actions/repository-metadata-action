...
Diffing and file categorization live in git_diff_operations.py.
"""
...
from .git_diff_operations import GitDiffOperationsMixin
...
class GitOperations(GitDiffOperationsMixin):
    ...
    def get_commit_files(self, sha: str = "HEAD") -> list[str]:
        ...
        try:
            ...
            return self._collect_diff_paths(parent.diff(commit))
